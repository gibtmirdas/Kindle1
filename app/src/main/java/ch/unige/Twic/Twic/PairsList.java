...
public class PairsList{
    ...
    /**
     * The list of {@link ch.unige.Twic.Twic.LanguagePair}
     */
    private static List<LanguagePair> listPairs = new ArrayList<>();

    /**
     * Add a {@link ch.unige.Twic.Twic.LanguagePair} to the list
     * @param lp {@link ch.unige.Twic.Twic.LanguagePair} to add
     */
    ...
    /**
     * Identify if the {@link ch.unige.Twic.Twic.LanguagePair} list contains a specific language as source already
    ...
    /**
     * Build an array containing the position in the {@link ch.unige.Twic.Twic.PairsList} of the source language and the target associated to the source
    ...
    /**
     * Identify if the {@link ch.unige.Twic.Twic.PairsList} already contain a {@link ch.unige.Twic.Twic.LanguagePair}
     * @param couple {@link ch.unige.Twic.Twic.LanguagePair} to test with
     * @return If the list already contains the {@link ch.unige.Twic.Twic.LanguagePair}
     */
